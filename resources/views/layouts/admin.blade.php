...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('/admin/users/create')}}"><i class="fa fa-list"></i> Create User</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018-2019 <a href="{{url("home")}}">Contenting.no</a>.</strong> All rights
        reserved.
    </footer>
